...
export const LiveOutputView: React.FC<LiveOutputViewProps> = ({ process, terminalHeight, maxLines = 2000 }) => {
  ...
  const renderScrollbar = () => {
    if (totalLines <= containerHeight) return null;
  ...
  return (
    <Box flexDirection="column" width="100%" height={terminalHeight} borderStyle="round" padding={1}>
      <Box>
      ...
      <Box marginTop={1} flexGrow={1} borderStyle="round" paddingX={1} flexDirection="row" overflow="hidden">
      ...
      <Box marginTop={1}>
        <Text color="gray">Use ↑↓/PgUp/PgDn to scroll. Press 'esc' to return.</Text>
      </Box>
    </Box>
  );
};
