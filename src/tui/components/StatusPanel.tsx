...
const formatUptime = (totalSeconds: number | null) => {
...
export const StatusPanel: React.FC<StatusPanelProps> = (props) => {
  ...
  const statusText = isConnected ? <Text color="green">● Connected</Text> : <Text color="red">○ Disconnected</Text>;
  ...
  const statusItems = [
    ...
    { 
      ...
      value: processCounts && (
        <Text>
          {processCount}{' '}
          (<Text color="green">{processCounts.running} running</Text>
